...
import {updateHeader} from '../../utils/util';
const NotFound = ({message}) => {
  ...
  return (
    <Route render={({ staticContext }) => {
      ...
      return (
        <div className="notfound container listc top-news">
          ...
          <svg width="320" height="240" viewBox="0 0 320 240">
              <defs>
                  ...
                  <linearGradient id="f" x1="95.386%" x2="0%" y1="50.69%" y2="61.048%">
                      <stop offset="0%" stopColor="#D8D8D8"/>
                      <stop offset="47.584%" stopColor="#BFBFBF"/>
                      <stop offset="100%" stopColor="#979797"/>
                  </linearGradient>
                  <radialGradient id="g" cx="42.929%" cy="56.547%" r="80.43%" fx="42.929%" fy="56.547%" gradientTransform="matrix(.70958 -.70306 .59881 .60168 -.214 .527)">
              ...
              <g fill="none" fillRule="evenodd">
                  <g>
                      ...
                      <g fill="#D1D1D1" fillRule="nonzero" mask="url(#c)">
                  ...
                  <g fill="#E9E9E9" fillRule="nonzero">
          ...
          <p>The page is irresponsive plese try again</p>
        </div>
      )
    }}/>
  ); 
